...
import '../styles/AppLayout.css'; // utilizing standard styling
...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const errorMsg = err.response?.data?.detail || err.message || 'Failed to log in. Please check your credentials.';
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', background: 'var(--bg-app)' }}>
            <div className="dark-card" style={{ maxWidth: '400px', width: '100%', padding: '40px', borderRadius: '16px', boxShadow: '0 10px 30px rgba(0,0,0,0.5)' }}>
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: '30px' }}>
                    ...
                    <h2 style={{ margin: 0, color: 'var(--text-primary)', fontSize: '1.8rem', fontWeight: 600 }}>Welcome Back</h2>
                    <p style={{ color: 'var(--text-secondary)', marginTop: '8px' }}>Sign in to continue to Picasso</p>
                </div>
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                    ...
                    <button
                        ...
                        style={{
                            ...
                            background: 'linear-gradient(90deg, #3b82f6 0%, #8b5cf6 100%)', color: 'white',
